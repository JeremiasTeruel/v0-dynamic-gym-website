...
export default function EditarUsuarioModal({ usuario, isOpen, onClose, onSave }: EditarUsuarioModalProps) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Guardar los datos del usuario y mostrar modal de PIN
    setPendingUserData(updatedData)
  ...
  return (
    <>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <FotoUsuario
                foto={formData.foto}
                onFotoChange={(url) => setFormData(prev => ({ ...prev, foto: url }))}
                userId={usuario?.id}
                oldUrl={formData.foto}
                size="md"
      ...
      <PinModal
        ...
        description={`Esta acción modificará los datos de ${formData.nombreApellido || "el usuario"}. Ingrese el PIN de seguridad para continuar.`}
      />
    </>
  )
}
