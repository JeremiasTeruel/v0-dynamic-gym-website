...
const uri =
  "mongodb+srv://gymadmin:gympassword123@cluster0.dtczv4t.mongodb.net/highPerformanceGymMaipu?retryWrites=true&w=majority&appName=Cluster0"
...
export async function getMongoDb() {
  try {
    ...
    if (!db) {
      ...
      db = client.db("highPerformanceGymMaipu")
