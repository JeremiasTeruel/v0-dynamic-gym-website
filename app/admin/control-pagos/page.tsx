...
import GraficoUsuariosActividad from "@/components/grafico-usuarios-actividad"
import GraficoUsuariosActivos from "@/components/grafico-usuarios-activos"
      ...
      {cargando || cargandoDatos || cargandoCaja ? (
        ...
        <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-2"} gap-6`}>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700">
              <h2 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Usuarios activos</h2>
              <GraficoUsuariosActivos usuarios={usuarios} />
            </div>
