          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="flex mb-6">
              <input
                ref={dniInputRef}
                type="text"
                placeholder={modoStaff ? "Ingresá el DNI del staff..." : "Ingresá tu DNI..."}
                value={searchDni}
              ...
              <div className="mt-4 flex flex-col items-center gap-2">
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2.5 rounded-full font-medium text-sm transition-colors border ${
                    modoStaff
                      ? "bg-white dark:bg-gray-800 text-indigo-700 dark:text-indigo-400 border-indigo-600 dark:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-gray-700"
                ...
                >
                  ...
                  {modoStaff ? "Usuarios" : "Staff"}
                </button>
                {modoStaff && (
                  <p className="text-xs text-gray-400 dark:text-gray-500">Buscando en la lista de staff</p>
                )}
              </div>
            </div>
